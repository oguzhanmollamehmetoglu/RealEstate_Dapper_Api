...
namespace DataAccessLayer.Repository
{
    public class StatisticsRepository : IStatisticsDal
    {
        ...
        {
            string query = "Select Name, Count(*) 'property_count' From Property Inner Join AppUser On Property.AppUserID=AppUser.UserID Group By Name Order By property_count Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
